...
print('\033[32m'+"-----------------Jogo da Velha-----------------\n")
print("Bem-vindo, eu sou o BOTlomeu, qual o seu nome?\n")
nome = input("Digite o seu nome: ")
print("\nMuito bom te ver por aqui", nome, "! Essas são as regras:")
...
while True:
    ...
    tabuleiro_inicial = """
Quando for a sua vez digite o número correspondente posição no tabuleiro para fazer sua jogada nela.")
print. Por exemplo, você quer jogar no centro, então você digita 5.
...
_____|_____|_____
  ...
  7  |  8  |  9  
    ...
    print("Então", nome, "você quer ser o X (xis) ou a O (bolinha)?", end=" ")

    while j != "O" and j != "X":
        j = str(input("Digite X ou O e pressione Enter para escolher: ")).strip().upper()
        if j != "O" and j != "X":
            print("\nEscolha direito, é X ou O\n")
    ...
    if j == "O":
        ...
        adv = "O"
        print("\nEntão eu fico com a bolinha.")

    print("\nQuem joga primeiro?", end=" ")

    while primeiro != "EU" and primeiro != "BOT":
        instr = "Digite EU para começar ou digite BOT para o mestre começar: "
        primeiro = str(input(instr)).strip().upper()
        if primeiro != "EU" and primeiro != "BOT":
            print("\nEscolha direito quem vai começar, é EU ou BOT \n")

    if primeiro == "EU":
        print("\nEntão você joga primeiro. Boa sorte,", nome, "\n")
    elif primeiro == "BOT":
        print("\nObrigado, eu começo então.\n")
...
_____|_____|_____
  ...
  {}  |  {}  |  {}
    ...
    def jogada_j1():
        ...
        while True:
            try:
                ...
                print("\nNão entendi. Digite um número de 1 a 9!\n")
    ...
    def checar_vencedor():
        global j, adv, turnos, vencedor, pts_jogador, pts_bot
        global p1, p2, p3, p4, p5, p6, p7, p8, p9
        ...
        if p1 == j and p2 == j and p3 == j or \
           ...
           p7 == j and p8 == j and p9 == j:
            print("VOCÊ GANHOU!", nome, "e superou o mestre BOTlomeu \n")
            pts_jogador += 1
            vencedor = "EU"
            turnos = 10
        ...
        if p1 == adv and p2 == adv and p3 == adv or \
           ...
           p7 == adv and p8 == adv and p9 == adv:
            print("EU GANHEI! O mestre nunca será superado >:D \n")
            pts_bot += 1
            vencedor = "BOT"
            turnos = 10
    ...
    def atualizar_tudo():
        ...
        if primeiro == "EU":
            ...
            if turnos == 5:
                print("NÓS EMPATAMOS! Finalmente um oponente a altura\n")
                turnos = 10
                vencedor = "EMPATE"
    ...
    print("-------- PONTOS --------")
    print("Você: {} | BOTlomeu: {}".format(pts_jogador, pts_bot))
    print("------------------------")

    while True:
        reiniciar = input("Você jogar de novo? Digite S para sim ou N para não: ").lower()
